<x-layout>
    ...
    @section('content')
        ...
        <x-div>
            ...
            <div class='flex flex-wrap gap-3 items-end mt-10
        ...
        <x-div class='pb-20'>
            ...
            <p>
                I possess a strong and broad skill set in <span class='text-terra-cotta'>user-centered design</span>, which includes conducting <span class='text-terra-cotta'>usability testing, interviews and surveys</span>, and working collaboratively with users to design and evaluate digital products.<br>
                I am experienced in both <span class='text-terra-cotta'>qualitative and quantitative analysis, generating requirements, wireframing, creating user flows and prototypes</span>, and using <span class='text-terra-cotta'>design thinking</span> to solve complex problems.<br>
                Additionally, I have <span class='text-terra-cotta'>research communication and reporting</span> skills, enabling me to effectively convey findings and recommendations to stakeholders and team members.
            </p>
            <div class='flex flex-wrap gap-3 items-end mt-10
            justify-start lg:justify-around'>
                ...
                <x-tag-item>{{ 'Requirements gathering' }}</x-tag-item>
